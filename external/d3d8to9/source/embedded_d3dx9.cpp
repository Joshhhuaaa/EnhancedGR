...
{
	// D3DCompile produces no D3DX constant table
	...
	LPCSTR pComments, LPD3DXBUFFER *ppDisassembly)
{
	...
	// D3DDisassemble needs a byte length, so scan for the 0x0000FFFF END token
...
bool InitEmbeddedD3DX()
{
	...
	// d3dx9_43's own HLSL path needs a d3dcompiler_43.dll that is not embedded
	if (p_D3DCompile != nullptr)
